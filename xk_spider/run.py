...
stdCode = '20221120023'  # 在''中填入你的学号
pswd = 'chen8525'  # 填你的密码
key = 'SCT214106TC0rjzdkiMLBpmRA5Weg81Rnq'  # 填你在server酱上获取到的key
path = 'C:/Program Files/Google/Chrome/Application/chromedriver'  # 填写你的chromedriver路径，如 '/usr/local/bin/chromedriver 或 C:/Program Files/Google/Chrome/Application/chromedriver'
